...
public class CarController {
    @RequestMapping("/info") //localhost:9090/car/info?make=Honda&year=2011
   public String carInfo(@RequestParam String make,@RequestParam Integer year, Model model){
    ...
    @RequestMapping("/info2") //localhost:9090/car/info?make=Honda&year=2011
    public String carInfo2(@RequestParam(value="make",required = false,defaultValue = "Tesla") String make, Model model){

        model.addAttribute("make",make);
        return "car/car-info";
    }
    @RequestMapping("/info/{make}/{year}") //localhost:9090/car/info/honda/2015
